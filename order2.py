  ...
  # print(psdata)
    ...
    def newline():
      ...
      def selectp2():
          ...
          sql21= 'INSERT INTO storingproduct(Productserviceid,orderid,sku,category,name,description,status,unitprice,peices,cost,taxable,priceminuscost,serviceornot,stock,stocklimit,warehouse,privatenote) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)'
          vatree=(child[0],osdata[0],child[2],child[3],child[4],child[5],child[6],child[7],child[8],child[9],child[10],child[11],child[12],child[13],child[14],child[15],child[16])
          fbcursor.execute(sql21,vatree,)
          fbilldb.commit()
          # messagebox.showinfo('Save','Save')
...
##
  ...
  xtracstval=orbtdata[10]
  cost=Label(summaryfrme, text="Extra cost").place(x=0 ,y=63)
  cost=Label(summaryfrme, text=str(orbtdata[10])+'/-').place(x=130 ,y=63)
...
checkvar1 = IntVar()
chkbtn1 = Checkbutton(lbframe, text = "Apply filter", variable = checkvar1, onvalue = 1, offvalue = 0, height = 2, width = 8,command=date_range,bg="#f8f8f2")
